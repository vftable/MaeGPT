    ...
    if (message.content === ".rst") {
      ...
      if (message.author.id === "577743466940071949" && guhmode) {
        ...
        if (!message.content.includes("[dragonfruit]")) {
          message.channel.sendTyping();
          messages.push({ role: "user", content: `my name is ${message.author.username}. my discord tag is ${message.author.tag}. you are in a channel called #${message.channel.name}. YOU MUST TALK IN ALL LOWERCASE EXCEPT IF YOU ARE WRITING CODE, DO NOT SAY ANYTHING AFTER. IF A CODEBLOCK IS IN THE ANSWER, ANSWER WITH ONLY THE CODEBLOCK. if you understand, answer this: ${message.content}` });
